...
export default function LeaderboardClient({ llms }: { llms: any[] }) {
    ...
    return (
        <main className="min-h-screen p-8 md:p-24 bg-white text-black font-comic selection:bg-yellow-200">
            <TransitionIris
                isOpen={!isExiting}
            ...
            <div className="max-w-6xl mx-auto space-y-12">
                <header className="space-y-4 text-center">
                    <h1 className="text-5xl md:text-7xl font-black tracking-tight transform -rotate-2">
                    ...
                    <div className="pt-8 relative z-10">
                        <a
                            href="/"
                            onClick={handleBack}
                            className="inline-block py-3 px-8 bg-black text-white font-black rounded-xl border-4 border-transparent hover:border-black hover:bg-white hover:text-black shadow-[4px_4px_0px_rgba(0,0,0,0.5)] hover:shadow-[8px_8px_0px_rgba(0,0,0,1)] hover:-translate-y-1 transition-all uppercase tracking-widest text-lg transform rotate-1 hover:rotate-0"
                        >
                            <span className="flex items-center justify-center gap-3">
                                <span>🔙</span> Back to the Tracks <span>🚋</span>
                            </span>
                        </a>
                    </div>
                </header>
