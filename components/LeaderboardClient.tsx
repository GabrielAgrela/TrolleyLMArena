...
export default function LeaderboardClient({ llms }: { llms: any[] }) {
    ...
    return (
        <main className="min-h-screen p-4 md:p-12 bg-white text-black font-comic selection:bg-yellow-200">
            <TransitionIris
                isOpen={!isExiting}
            ...
            <div className="max-w-6xl mx-auto space-y-4 md:space-y-6">
                <header className="space-y-2 text-center">
                    <h1 className="text-4xl md:text-7xl font-black tracking-tight transform -rotate-2 flex items-center justify-center gap-4 flex-wrap">
                        ...
                        <span className="text-lg md:text-2xl text-black font-bold self-end -ml-2">(beta)</span>
                    </h1>
